...
echo 'Installing /usr/lib/initcpio/hooks/iscsi...'
...
echo 'Installing packages and updating /boot/initramfs-linux*.img...'
pacman -Sy --noconfirm open-iscsi mkinitcpio-nfs-utils
